...
fn main() /*-> eframe::Result<()>*/
{
    ...
    unsafe { println!("{}", xasync::get_status(&mut async_block as *mut XAsyncBlock, true)) };
    ...
    unsafe { println!("xasync::get_status {}", xasync::get_status(&mut async_block as *mut XAsyncBlock, true)) };
