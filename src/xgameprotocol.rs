...
pub type XGameProtocolActivationCallback = unsafe extern "system" fn(_context: *mut c_void, _protocol_uri: *const c_char) -> ();
...
pub unsafe trait IXGameProtocol: IUnknown {
    ...
    unsafe fn x_game_protocol_register_for_activation(
        self: &Self,
    ...
    unsafe fn x_game_protocol_unregister_for_activation(
        self: &Self,
